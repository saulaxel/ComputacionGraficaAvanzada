...
Box boxViewDepth; // Objeto para dibujar el renderizado desde el punto de vista de la luz
...
void applicationLoop() {
	...
	while (psi) {
		...
		lightProjection = glm::ortho<float>(-25.0, 25.0, -25.0, 25.0f, near_plane, far_plane);
...
void prepareDepthScene(){ // Si se agregan otros objetos en la escena se debe setear el shader de profundidad
