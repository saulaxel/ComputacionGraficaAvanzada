...
std::vector<float> lamp1Orientation = { -17.0, -82.67, 23.70, 33.97 };
...
void applicationLoop() {
	...
	while (psi) {
		...
		/*******************************************
		 * Propiedades Spot Lights
		 *******************************************/
		glm::vec4 spotPosition = modelMatrixHeli * glm::vec4(0.0f, 0.3f, 2.04f, 1.0);
		shaderMulLighting.setInt("spotLightCount", 1);
		shaderTerrain.setInt("spotLightCount", 1);
		shaderMulLighting.setVectorFloat3("spotLights[0].light.ambient", glm::value_ptr(glm::vec3(0.0f, 0.0f, 0.0f)));
		shaderMulLighting.setVectorFloat3("spotLights[0].light.diffuse", glm::value_ptr(glm::vec3(0.2f, 0.2f, 0.2f)));
		...
		shaderTerrain.setVectorFloat3("spotLights[0].light.diffuse", glm::value_ptr(glm::vec3(0.2f, 0.2f, 0.2f)));
		...
		for (int i = 0; i < lamp2Position.size(); i++) {
			...
			matrixAdjustLamp = glm::scale(matrixAdjustLamp, glm::vec3(1, 1, 1));
			matrixAdjustLamp = glm::translate(matrixAdjustLamp, glm::vec3(0.76445f, 4.994f, 0.0));
			...
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].light.specular", glm::value_ptr(glm::vec3(0.6f, 0.5f, 0.02f)));
			...
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].light.specular", glm::value_ptr(glm::vec3(0.6f, 0.5f, 0.02f)));
			...
			shaderTerrain.setFloat("pointLights[" + std::to_string(lamp1Position.size() + i) + "].quadratic", 0.01f);
		}
